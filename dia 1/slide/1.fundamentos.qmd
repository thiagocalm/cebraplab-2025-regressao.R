...
## Formas de se captar a interação entre fenômenos sociais {.theme-subtopic .smaller .font-size-smallest .r-fit-text}
...
![](images/programa-pe-meia.png){.absolute bottom=20 right=150 .r-stretch}
...
:::{.column width="30%"}
### Significância estatística{style="text-align: center;" .r-fit-text}
...
:::{.column width="30%"}
### Força da relação entre elas{style="text-align: center;" .r-fit-text}
...
:::{.column width="30%"}
### Direção da diferença{style="text-align: center;" .r-fit-text}
...
## Correlação e causalidade {.theme-subtopic .smaller .font-size-smallest}
...
#### Limitações{style="text-align: center;"}
- Embora poderoso, estabelecer relações diretas entre fenômenos sociais é quase impossível de ser feito na vida real de pesquisa.
...
## Motivações para se modelar fenômenos sociais {.theme-subtopic .r-fit-text .smaller .font-size-smallest}

Pode-se estar interessado em predizer tendências futuras para determinado fenômeno sociais de interesse ou compreender em que medida um fenômeno afeta outro.
...
- Muito utilizados, atualmente, em modelos de aprendizado de máquina (*machine learning*)^[Ver texto complementar na leitura da aula de hoje.].

:::

:::{.column width="50%"}
### Relação entre fenômenos{style="text-align: center;"}
Mais comuns em estudos de políticas públicas para desenho de programas sociais, em estudos acadêmicos ou em estudos de mercado, esses modelos buscam estabelcer a relação entre um fenômeno $X_1$ e o fenômeno de interesse $Y$ a partir do *controle* por outras variáveis que também podem afetar $Y$^[Ver texto do ENAP (2019) presente na leitura da aula de hoje.].
